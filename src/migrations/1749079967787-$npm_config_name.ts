...
export class $npmConfigName1749079967787 implements MigrationInterface {
  name = ' $npmConfigName1749079967787';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "producers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "cpf_cnpj" character varying NOT NULL, CONSTRAINT "UQ_69c9e8a2abe4f39ee6d64d8977e" UNIQUE ("cpf_cnpj"), CONSTRAINT "PK_7f16886d1a44ed0974232b82506" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "crops" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "season" character varying(50) NOT NULL, "culture_name" character varying(50) NOT NULL, "farm_id" character varying NOT NULL, "farmId" uuid, CONSTRAINT "PK_098dbeb7c803dc7c08a7f02b805" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "crops" ADD CONSTRAINT "FK_22c38f5ca32439c43bf2a9142a2" FOREIGN KEY ("farmId") REFERENCES "farms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
